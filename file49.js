...
const students = [
  ...
  { id: 4, name: "Ayush", s1: true, s2: true, s3: true },
];
...
//promise.race()  =>  Return the promise that settels(resolve or reject)
//Promise.any  => Returns the first fulfilled promise.Ignores rejection unless all fail
